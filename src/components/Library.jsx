...
export default function Library() {
  ...
  return (
    <div className="rounded-md bg-gray-900/40 max-w-80 pt-2">
      <div className="flex flex-col">
        <div className="flex flex-row justify-between ps-2 pe-4">
          ...
          <div className="flex flex-row gap-3 text-gray-400 self-center">
            <PlusIcon className="size-6 h-10 transition-all duration-200 ease-in-out hover:text-white cursor-pointer" />
            <ArrowRightIcon className="size-6 h-10  transition-all duration-200 ease-in-out hover:text-white cursor-pointer" />
          </div>
        </div>
        ...
        <div className="flex flex-col lg:h-[75vh] overflow-y-auto">
          <div className="flex flex-row gap-x-2 p-2 mx-1 justify-between">
            <div>
              <MagnifyingGlassIcon className="h-6 text-gray-400 transition-all duration-200 ease-in-out hover:text-white cursor-pointer" />
              <input type="text" placeholder="" className="hidden" />
            </div>
            <div className="flex flex-row self-center gap-x-2 text-gray-400 transition-all duration-200 ease-in-out hover:text-white hover:scale-y-105 cursor-pointer">
